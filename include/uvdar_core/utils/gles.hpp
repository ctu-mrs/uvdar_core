...
namespace uvdar_core::utils::GLES {
...
inline GLsizei get_type_size(GLenum type)
{
    switch (type) {
...
inline GLuint get_image_format_num_components(GLenum format)
{
    switch (format) {
    case GL_RED:
    case GL_RED_INTEGER:
...
inline GLenum get_image2d_compatibility_format(GLenum internal_format)
{
...
inline const char* get_glsl_image2d_type(GLenum compatibility_format)
{
...
inline const char* get_glsl_image2d_format_qualifier(GLenum compatibility_format)
{
    switch (compatibility_format) {
    case GL_RGBA32F:
        return "rgba32f";
...
inline const char* get_glsl_image2d_access(GLenum access)
{
    switch (access) {
    case GL_READ_ONLY:
        return "readonly";
...
inline const char* get_glsl_data_type(GLenum type)
{
    switch (type) {
    case GL_UNSIGNED_INT:
        return "uint";

...
{
  printf("[ComputeLib]: Checking if initialized... " );
    if (inst->initialised == true) {
        return COMPUTE_LIB_ERROR_ALREADY_INITIALISED;
    }

    printf("[ComputeLib]: Opening GPU DRI PATH... " );
    ...
    printf("[ComputeLib]: Creating BGM device... " );
    ...
    printf("[ComputeLib]: Getting EGL platform display... " );
    ...
    printf("[ComputeLib]: Initializing EGL... " );
    if (!eglInitialize(inst->dpy, NULL, NULL)) {
        compute_lib_deinit(inst);
        return COMPUTE_LIB_ERROR_EGL_INIT;
    }

    printf("[ComputeLib]: Getting EGL extensions... " );
    ...
    printf("[ComputeLib]: Making EGL current... " );
    ...
    printf("[ComputeLib]: Enabling GL output... " );
    glEnable(GL_DEBUG_OUTPUT);
    printf("[ComputeLib]: Setting message callback... " );
    glDebugMessageCallback(compute_lib_gl_callback, (const void*) inst);
    
    printf("[ComputeLib]: Initialized... " );

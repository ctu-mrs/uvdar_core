...
### Dev Notes
- [ ] BlinkProcessor may be prone to race conditions
- [ ] Check active t-series buffer (overflow/sync issues)
- [x] Config parameter names are very confusing at this point.
- [ ]  

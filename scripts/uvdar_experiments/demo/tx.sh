...
'
  'Trajectory' 'history -s roslaunch uvdar_core load_trajectory.launch file:="demo/tx_fly_by.txt" loop:=true; rosservice call /'"$UAV_NAME"'/control_manager/goto_trajectory_start
'

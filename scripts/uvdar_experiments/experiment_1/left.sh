...
'
  'Trajectory' 'history -s roslaunch uvdar_core load_trajectory.launch file:=rectangular_left.txt loop:=true; rosservice call /'"$UAV_NAME"'/control_manager/goto_trajectory_start
'

...
'
  'Trajectory' 'history -s roslaunch uvdar_core load_trajectory.launch file:="demo/rx2_still.txt"; rosservice call /'"$UAV_NAME"'/control_manager/goto_trajectory_start
'

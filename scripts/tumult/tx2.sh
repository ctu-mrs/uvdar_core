...
'
  'Trajectory' 'history -s roslaunch uvdar_core load_trajectory.launch file:="tumult/rx_still/tx2_fly_by.txt"; rosservice call /'"$UAV_NAME"'/control_manager/goto_trajectory_start
'

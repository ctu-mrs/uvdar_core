...
'
  'Luxonis' 'waitForTime; roslaunch ~/git/luxonis.launch
'
...
'
  'UVDAR' 'waitForHw; roslaunch uvdar_core rw_three_sided_basler.launch
'
  'RGBCam' 'waitForHw; roslaunch uvdar_core rgbcam_basler.launch
'

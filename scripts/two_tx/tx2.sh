...
'
  'Trajectory' 'history -s roslaunch uvdar_core load_trajectory.launch file:="two_tx/tx2_fly_by.txt" dt:=4 loop:=true; rosservice call /'"$UAV_NAME"'/control_manager/goto_trajectory_start
'
